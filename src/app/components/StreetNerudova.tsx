...
import {
    GalleryNerudova
} from "../nase-realizace/GalleryNerudova";
import Image from "next/image";

import Wrapper from "./Wrapper";
import SectionHeading from "./SectionHeading";

const StreetNerudova = () => {
    ...
    return (
        <Fragment>
            <Wrapper>
                <SectionHeading>
                    Jednorámová okna Praha ulice Nerudova
                </SectionHeading>
                <Wrapper className="mt-2 md:mt-4 lg:mt-6 flex justify-center items-center md:flex-row flex-col flex-wrap gap-2 md:gap-4 lg:gap-6">
                    {
                        GalleryNerudova.map((card, index) => {
                            ...
                            return (
                                <Fragment key={index}>
                                    <Wrapper className="relative group cursor-pointer">
                                        ...
                                        // onClick={() => setActiveCarousel({ gallery: "Jemniste", index: index })}
                                        />

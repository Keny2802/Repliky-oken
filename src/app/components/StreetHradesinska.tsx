...
import {
    GalleryHradesinska
} from "../nase-realizace/GalleryHradesinska";
    ...
    return (
        <Fragment>
            <Wrapper className="p-2.5 md:p-3 lg:p-4 bg-[#f5f2e8] border-t border-gray-200">
                <SectionHeading>
                    Rekonstrukce historické vily, Praha ulice Hradešínská
                </SectionHeading>
            ...
            </Wrapper>
            {
                activeIndex !== null && (
                    <Fragment>
                        <Carousel
                        carouselSet={GalleryHradesinska.map((card) => card.image)}
...
export default StreetHradesinska;